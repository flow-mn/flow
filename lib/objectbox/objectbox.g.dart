  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    Account: obx_int.EntityDefinition<Account>(
        ...
        objectFromFB: (obx.Store store, ByteData fbData) {
          ...
          final creditLimitParam = const fb.Float64Reader()
    ...
    UserPreferences: obx_int.EntityDefinition<UserPreferences>(
        ...
        objectFromFB: (obx.Store store, ByteData fbData) {
          ...
          final transactionListTileShowCategoryNameParam =
              const fb.BoolReader().vTableGet(buffer, rootOffset, 24, false);
          final transactionListTileShowAccountForLeadingParam =
              const fb.BoolReader().vTableGet(buffer, rootOffset, 26, false);
          final trashBinRetentionDaysParam =
              const fb.Int64Reader().vTableGetNullable(buffer, rootOffset, 14);
          final defaultFilterPresetParam =
              const fb.StringReader(asciiOptimization: true)
                  .vTableGetNullable(buffer, rootOffset, 12);
          final enableICloudSyncParam =
              const fb.BoolReader().vTableGet(buffer, rootOffset, 28, false);
          final autoBackupIntervalInHoursParam =
    ...
    Budget: obx_int.EntityDefinition<Budget>(
        ...
        objectFromFB: (obx.Store store, ByteData fbData) {
          ...
          final currencyParam = const fb.StringReader(asciiOptimization: true)
              .vTableGet(buffer, rootOffset, 14, '');
          final rangeParam = const fb.StringReader(asciiOptimization: true)
    ...
    RecurringTransaction: obx_int.EntityDefinition<RecurringTransaction>(
        ...
        objectToFB: (RecurringTransaction object, fb.Builder fbb) {
          final uuidOffset = fbb.writeString(object.uuid);
          final jsonTransactionTemplateOffset =
              fbb.writeString(object.jsonTransactionTemplate);
          final rangeOffset =
          ...
          fbb.addInt64(
              9, object.lastGeneratedTransactionDate?.millisecondsSinceEpoch);
        ...
        objectFromFB: (obx.Store store, ByteData fbData) {
          final buffer = fb.BufferContext(fbData);
          final rootOffset = buffer.derefObject(0);
          final lastGeneratedTransactionDateValue =
              const fb.Int64Reader().vTableGetNullable(buffer, rootOffset, 22);
          final idParam =
              const fb.Int64Reader().vTableGet(buffer, rootOffset, 4, 0);
          final disabledParam =
          ...
          final rulesParam = const fb.ListReader<String>(
                  ...
                  lazy: false)
              .vTableGet(buffer, rootOffset, 12, []);
          final jsonTransactionTemplateParam =
              const fb.StringReader(asciiOptimization: true)
                  .vTableGet(buffer, rootOffset, 8, '');
          final transferToAccountUuidParam =
              const fb.StringReader(asciiOptimization: true)
                  .vTableGetNullable(buffer, rootOffset, 20);
          final createdDateParam = DateTime.fromMillisecondsSinceEpoch(
          ...
          final lastGeneratedTransactionUuidParam =
              const fb.StringReader(asciiOptimization: true)
...
class Account_ {
  ...
  static final creditLimit =
      obx.QueryDoubleProperty<Account>(_entities[0].properties[9]);

  /// See [Account.showCreditLimit].
  static final showCreditLimit =
      obx.QueryBooleanProperty<Account>(_entities[0].properties[10]);

  /// See [Account.type].
  static final type =
      obx.QueryStringProperty<Account>(_entities[0].properties[11]);
...
class BackupEntry_ {
  ...
  static final iCloudRelativePath =
      obx.QueryStringProperty<BackupEntry>(_entities[3].properties[6]);

  /// See [BackupEntry.iCloudChangeDate].
  static final iCloudChangeDate =
      obx.QueryDateProperty<BackupEntry>(_entities[3].properties[7]);
}
...
class Transaction_ {
  ...
  static final extraTags =
      obx.QueryStringVectorProperty<Transaction>(_entities[4].properties[17]);
}
...
class UserPreferences_ {
  ...
  static final enableICloudSync =
      obx.QueryBooleanProperty<UserPreferences>(_entities[6].properties[11]);
}
...
class Budget_ {
  /// See [Budget.id].
  static final id =
      obx.QueryIntegerProperty<Budget>(_entities[7].properties[0]);

  /// See [Budget.uuid].
  static final uuid =
      obx.QueryStringProperty<Budget>(_entities[7].properties[1]);

  /// See [Budget.createdDate].
  static final createdDate =
      obx.QueryDateProperty<Budget>(_entities[7].properties[2]);

  /// See [Budget.name].
  static final name =
      obx.QueryStringProperty<Budget>(_entities[7].properties[3]);

  /// See [Budget.amount].
  static final amount =
      obx.QueryDoubleProperty<Budget>(_entities[7].properties[4]);

  /// See [Budget.currency].
  static final currency =
      obx.QueryStringProperty<Budget>(_entities[7].properties[5]);

  /// See [Budget.category].
  static final category =
      obx.QueryRelationToOne<Budget, Category>(_entities[7].properties[6]);

  /// See [Budget.categoryUuid].
  static final categoryUuid =
      obx.QueryStringProperty<Budget>(_entities[7].properties[7]);

  /// See [Budget.range].
  static final range =
      obx.QueryStringProperty<Budget>(_entities[7].properties[8]);
}
...
class RecurringTransaction_ {
  ...
  static final uuid =
      obx.QueryStringProperty<RecurringTransaction>(_entities[8].properties[1]);
  ...
  static final range =
      obx.QueryStringProperty<RecurringTransaction>(_entities[8].properties[3]);
  ...
  static final createdDate =
      obx.QueryDateProperty<RecurringTransaction>(_entities[8].properties[5]);
